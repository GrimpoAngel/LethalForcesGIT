...
public class EnemyWaveSystem : MonoBehaviour {
	...
	public EnemyWave[] EnemyWaves; //how many enemy waves will the player fight through
	...
	void UpdateAreaColliders(){
        ...
        if (cf != null) cf.CurrentBackCollider = EnemyWaves [currentWave].BackAreaCollider; //LETHAL FORCES - add backcollider to camera
    ...
    //LETHAL FORCES - turn on Back Area Restrictors
    public void BlockBackArea()
    {
        BoxCollider blockCollider = EnemyWaves[currentWave].BackAreaCollider;

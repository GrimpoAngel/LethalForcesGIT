...
public class EnemyActions_LF : MonoBehaviour {

    [Space(10)]
    [Header("Linked components")]
    public GameObject target; //current target
    public static GameObject[] targets; //array of objects with tag PLAYER
	...
	[Header ("Stats")]
	public RANGE range;
	public ENEMYTACTIC2 enemyTactic;
	...
	public void Hit(DamageObject d){
		if(HitableStates.Contains(enemyState)) {
			...
			if(d.knockDown) {
				...
				if(enemyTactic != ENEMYTACTIC2.ENGAGE) {
